export const defaultEntitiesValues = [
  {
    nom: 'Pioche',
    image: './assets/entities/wooden-pickaxe.webp',
    cout_initial: 15,
    rendement_initial: 0.1,
    description: '"Un bout de bois taillé, un grand avenir. Qui a dit que commencer petit était un problème ?"'
  },
  {
    nom: 'Villageois',
    image: './assets/entities/villager.webp',
    cout_initial: 100,
    rendement_initial: 1,
    description: '"Ils troqueraient volontiers votre fortune contre une émeraude… Mais ici, ils minent pour vous !"'
  },
  {
    nom: 'Poulet',
    image: './assets/entities/chicken.webp',
    cout_initial: 700,
    rendement_initial: 8,
    description: '"Difficile de miner sans bras… mais ils ont trouvé un moyen. Ne posez pas de questions."'
  },
  {
    nom: 'Zombie',
    image: './assets/entities/zombie.webp',
    cout_initial: 5000,
    rendement_initial: 47,
    description: '"Ils creusent sans relâche à la recherche de… on sait pas trop, en fait. Mais ça marche."'
  },
  {
    nom: 'Mineshaft',
    image: './assets/entities/mineshaft.webp',
    cout_initial: 30000,
    rendement_initial: 260,
    description: '"Qui a bien pu creuser ces galeries ? Peu importe, elles sont à vous maintenant."'
  },
  {
    nom: 'Champimeuh',
    image: './assets/entities/mooshroom.webp',
    cout_initial: 200000,
    rendement_initial: 1400,
    description: '"Leurs spores colonisent la roche et transforment tout en champignons… et en ressources !"'
  },
  {
    nom: 'Araignée',
    image: './assets/entities/spider.webp',
    cout_initial: 1200000,
    rendement_initial: 7800,
    description: '"Elles tissent des toiles si solides qu’elles extraient même les minerais des murs."'
  },
  {
    nom: 'Golem de neige',
    image: './assets/entities/ice-golem.webp',
    cout_initial: 8000000,
    rendement_initial: 44000,
    description: '"Lanceur de boules de neige invétéré, il ne sait pas miner… mais il s’acharne jusqu’à ce que la pierre cède."'
  },
  {
    nom: 'Wither',
    image: './assets/entities/wither.webp',
    cout_initial: 60000000,
    rendement_initial: 260000,
    description: '"Pourquoi miner à la main quand on peut tout faire exploser ?"'
  },
  {
    nom: 'Portail de l’End',
    image: './assets/entities/end-portal.webp',
    cout_initial: 500000000,
    rendement_initial: 1600000,
    description: '"Ouvre une porte vers une autre dimension… où tout est à vous. Attention aux dragons."'
  }
];

export const defaultShopValues = [
  {
    nom: 'Doigt de Notch',
