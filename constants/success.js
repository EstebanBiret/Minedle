export const succes = [
    ...
    { id: 4, nom: "Ingénieur survolté", description: "Vous avez atteint la profondeur de la redstone.", image: "./assets/success/4.webp", categorie: "profondeur", seuil: 0 },
    { id: 5, nom: "Enchantements !", description: "Vous avez atteint la profondeur du lapis-lazuli.", image: "./assets/success/5.webp", categorie: "profondeur", seuil: 0 },
    { id: 6, nom: "Le joyau du village", description: "Vous avez atteint la profondeur de l’émeraude.", image: "./assets/success/6.webp", categorie: "profondeur", seuil: 0 },
    { id: 7, nom: "Mineur de luxe", description: "Vous avez atteint la profondeur du diamant.", image: "./assets/success/7.webp", categorie: "profondeur", seuil: 0 },
        
    { id: 8, nom: "Mineur du dimanche", description: "Vous avez miné 100 blocs en cliquant.", image: "./assets/success/8.webp", categorie: "clics", seuil: 100 },
    { id: 9, nom: "Cliqueur acharné", description: "Vous avez miné 2 000 blocs en cliquant.", image: "./assets/success/9.webp", categorie: "clics", seuil: 2000 },
    { id: 10, nom: "Pauvre souris", description: "Vous avez miné 10 000 blocs en cliquant.", image: "./assets/success/10.webp", categorie: "clics", seuil: 10000 },
    ...
    { id: 23, nom: "Tisseur de cauchemars", description: "Vous avez acheté 50 Araignées.", image: "./assets/success/23.jpg", categorie: "Araignée", seuil: 50 },
    { id: 24, nom: "Hiver éternel", description: "Vous avez acheté 50 Golems de neige.", image: "./assets/success/24.png", categorie: "Golem de neige", seuil: 50 },
    { id: 25, nom: "Fléau des âmes", description: "Vous avez acheté 50 Withers.", image: "./assets/success/25.png", categorie: "Wither", seuil: 50 },
    { id: 26, nom: "Maître de l’End", description: "Vous avez acheté 50 Portails de l’End.", image: "./assets/success/26.png", categorie: "Portail de l’End", seuil: 50 },

    { id: 27, nom: "Collectionneur chevronné", description: "Vous avez acheté au moins 25 exemplaires de chaque entité.", image: "./assets/success/27.webp", categorie: "divers", seuil: 25 },
